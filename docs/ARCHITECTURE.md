...
│   │   ├── systems/          3,243  ERP prototype generator
...
│   │   ├── systems/          1,906  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 87 files,
