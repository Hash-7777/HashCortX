...
│   │   ├── agent-maker/      2,305  chain / vote / failover
...
│   │   ├── swarm/            2,313  Agent Swarm: what kind of task it is,
