...
│   │   ├── agent-maker/      2,424  chain / vote / failover
...
│   │   ├── swarm/            1,556  Agent Swarm: layout, scheduling, fencing,
...
│   │   │                            its agents can be asked for changes
