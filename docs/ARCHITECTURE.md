...
│   │   ├── systems/          3,244  ERP prototype generator
...
│   │   ├── systems/          2,130  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 89 files,
