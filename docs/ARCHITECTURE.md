...
│   │   ├── code/               413  Coder: terminal colour, export, file names,
│   │   │                            and patch_file's text work
│   │   ├── swarm/            1,987  Agent Swarm: what kind of task it is,
...
│   │   ├── commands/
│   │   │   ├── shell.rs       719   process execution: denylist, timeout, stop,
