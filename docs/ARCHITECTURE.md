...
│   │   ├── app.js            6,484  core: state, chat, agents, tools, providers
...
│   │   ├── agent-shape.js      583  images, tools and tool results per provider,
