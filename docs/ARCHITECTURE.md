...
│   │   ├── app.js            6,446  core: state, chat, agents, tools, providers
...
│   │   │                            model can answer it
│   │   ├── local-context.js     82  how much a local model is given room to
│   │   │                            read: sized to the request, so Ollama never
│   │   │                            drops its instructions
│   │   ├── local-client.js     127  the one request to a local model and the one
│   │   │                            reading of its reply: words, thinking and
│   │   │                            tool calls as they arrive
│   │   ├── agent-shape.js      562  images, tools and tool results per provider,
...
│   │   │                            conversation, and what its builder is told
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 102 files,
