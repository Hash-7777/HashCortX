...
│   │
│   ├── js/
│   │   ├── app.js            8,484  core: state, chat, agents, tools, providers
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 574 of
