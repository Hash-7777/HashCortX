...
│   │   ├── mcp/              1,194  connected systems over MCP: which of a
...
│   │   ├── systems/          5,517  ERP: spec, money, domain, the generated books,
