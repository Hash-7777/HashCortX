...
│   │   ├── agent-maker/      2,438  chain / vote / failover
...
│   │   ├── swarm/            4,332  Agent Swarm: what kind of task it is,
