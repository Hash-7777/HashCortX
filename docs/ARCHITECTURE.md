...
│   │   ├── systems/          3,261  ERP prototype generator
...
│   │   ├── swarm/            1,860  Agent Swarm: what kind of task it is,
...
│   │   ├── systems/          1,637  ERP: spec, money, domain, the generated books,
│   │   │                            how every screen shows a record, and the
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 84 files,
