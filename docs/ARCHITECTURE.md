...
│   │   ├── agent-maker/      2,828  chain / vote / failover
...
│   │   ├── swarm/             534  Agent Swarm: layout, scheduling, fencing,
│   │   │                            and the files a site is made of
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 78 files,
