...
│   │   ├── systems/          3,219  ERP prototype generator
...
│   │   ├── systems/          1,751  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 85 files,
