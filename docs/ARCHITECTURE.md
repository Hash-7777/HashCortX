...
│   │   ├── systems/          3,250  ERP prototype generator
...
│   │   ├── systems/          2,309  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 90 files,
