...
│   │   ├── systems/          3,163  ERP prototype generator
...
│   │   ├── systems/          1,828  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 86 files,
