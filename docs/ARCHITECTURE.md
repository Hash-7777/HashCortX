...
│   │   ├── forge/            3,683  offline parametric part generator
...
│   │   ├── agent-maker/      2,281  chain / vote / failover
...
│   │   │                            file compared
│   │   ├── forge/            5,170  Forge: fields, surfaces, units, the plan
│   │   │                            gate, the one path a design takes to the
│   │   │                            scene, and io/ — STL, OBJ, 3MF and STEP
