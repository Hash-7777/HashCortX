...
│   │   ├── systems/          3,272  ERP prototype generator
...
│   │   ├── systems/          1,455  ERP: spec, money, domain, the generated books,
│   │   │                            and how every screen shows a record
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 83 files,
