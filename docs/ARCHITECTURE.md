...
│   │   ├── agent-maker/      2,419  chain / vote / failover
...
│   │   ├── swarm/            1,254  Agent Swarm: layout, scheduling, fencing,
