...
│   │   ├── systems/          3,109  ERP prototype generator
...
│   │   ├── systems/          2,477  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 91 files,
