...
│   │   ├── app.js            6,497  core: state, chat, agents, tools, providers
...
│   │   ├── chat/               482  what a model is told, which to try next
│   │   │                            (an agent's turns too), the web searches
│   │   │                            an agent makes, and what its code printed
