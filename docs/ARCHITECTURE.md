...
│   │   ├── systems/          3,182  ERP prototype generator
...
│   │   ├── systems/          2,007  ERP: spec, money, domain, the generated books,
...
│   └── tauri.conf.json
│
├── scripts/checks/                  the automated frontend checks — 88 files,
