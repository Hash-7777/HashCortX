...
//   and the model answers from what came back (js/chat/decide.js). The
...
(function () {
  ...
  /** The connected systems the ERP agent may read with this model: some reading tool switched on, and its records allowed to reach the model. */
