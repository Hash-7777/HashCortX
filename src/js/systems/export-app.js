...
(function () {
  ...
  const SCRIPTS = [
    ...
    '/js/systems/stages.js', '/js/systems/relations.js', '/js/systems/forms.js', '/js/systems/edits.js', '/js/systems/work.js',
    '/js/systems/figures.js', '/js/systems/money.js', '/js/systems/samples.js', '/js/systems/domain.js', '/js/systems/scaffold.js',
    '/js/systems/setup.js', '/js/systems/prompts.js', '/js/systems/agent.js', '/js/mcp/records.js', '/js/systems/connected.js', '/js/systems/agent-chat.js', '/js/systems/contrast.js', '/js/systems/theme.js', '/js/systems/books.js', '/js/systems/ledger.js',
