...
(function () {
  ...
  const SCRIPTS = [
    ...
    '/js/systems/setup.js', '/js/systems/prompts.js', '/js/systems/agent.js', '/js/systems/connected.js', '/js/systems/agent-chat.js', '/js/systems/contrast.js', '/js/systems/theme.js', '/js/systems/books.js', '/js/systems/ledger.js',
