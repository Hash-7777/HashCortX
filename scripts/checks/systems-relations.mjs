...
ok('a form sets a link from the target\'s records', /REL\(\)\.choices\(getRuntimeData\(spec\)\[target\.id\]/.test(mode));
ok('a formula field is shown worked out, not typed', /readonly title="Worked out:/.test(mode));
